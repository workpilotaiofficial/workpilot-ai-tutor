...
export const metadata: Metadata = { title: "Privacy Policy | Neurova", description: "How Neurova collects, uses, and protects personal information." };

export default function PrivacyPolicyPage() {
  return (
    <SitePageShell eyebrow="Legal" title="Privacy Policy" description="This policy explains what information Neurova handles when you use our AI-powered study tools and how you can exercise your privacy choices.">
      <PolicyContent>
        <EffectiveDate />
        <PolicySection title="1. Scope and who we are">
          <p>Neurova provides AI-assisted study sets, quizzes, notes, syllabus analysis, paper grading, tutoring experiences, and related account and billing features. This policy applies to our website, dashboard, and services (collectively, the “Service”).</p>
        </PolicySection>
        ...
        <PolicySection title="4. AI processing and uploaded content">
          ...
          <p>AI output may be inaccurate. Neurova does not use AI output to make decisions with legal or similarly significant effects about you.</p>
        </PolicySection>
