...
export const metadata: Metadata = { title: "Terms of Service | Neurova", description: "Terms governing access to and use of Neurova." };

export default function TermsPage() {
  return (
    <SitePageShell eyebrow="Legal" title="Terms of Service" description="These terms set the rules for using Neurova’s AI study platform, accounts, subscriptions, credits, and generated learning materials.">
      <PolicyContent>
        <EffectiveDate />
        <PolicySection title="1. Agreement to these terms">
          <p>By accessing or using Neurova (the “Service”), you agree to these Terms and our <a href="/privacy-policy">Privacy Policy</a>. If you use the Service for a school, company, or other organization, you confirm you have authority to bind that organization. If you do not agree, do not use the Service.</p>
        </PolicySection>
        ...
        <PolicySection title="4. Your content and our license">
          <p>You retain ownership of content you upload or submit and are responsible for having the rights and permissions needed to use it. You grant Neurova a limited, non-exclusive, worldwide license to host, copy, transmit, process, adapt, and display your content only as reasonably necessary to operate, secure, and improve the Service and fulfill your requests.</p>
        ...
        <PolicySection title="8. Third-party services">
          <p>The Service relies on third parties such as authentication, payment, hosting, analytics, and AI providers. Their products may be governed by separate terms. Neurova is not responsible for third-party services outside our control.</p>
        </PolicySection>
        <PolicySection title="9. Intellectual property">
          <p>The Service, including its software, design, branding, and documentation, belongs to Neurova or its licensors. Except for the limited right to use the Service under these Terms, no rights are transferred to you. Feedback you provide may be used without restriction or compensation.</p>
        </PolicySection>
        <PolicySection title="10. Disclaimers and limitation of liability">
          <p>To the fullest extent permitted by law, the Service is provided “as is” and “as available” without warranties of accuracy, availability, fitness for a particular purpose, or non-infringement. Neurova is not liable for indirect, incidental, special, consequential, exemplary, or punitive damages, loss of data, grades, profits, or opportunities.</p>
          <p>To the fullest extent permitted by law, Neurova’s total liability arising from the Service will not exceed the amount you paid Neurova during the 12 months before the event giving rise to the claim. Nothing in these Terms excludes liability that cannot legally be excluded.</p>
        </PolicySection>
