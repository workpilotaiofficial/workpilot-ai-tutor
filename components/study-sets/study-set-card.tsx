    ...
    return (
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <Link href={`/dashboard/study-sets/${set.id}`} className="text-base font-bold text-foreground group-hover:text-primary transition-colors truncate">
            {set.title}
          </Link>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between border-b border-border px-6 py-5">
        <Link href={`/dashboard/study-sets/${set.id}`} className="min-w-0 truncate text-lg font-semibold text-foreground group-hover:text-primary">
          {set.title}
        </Link>
